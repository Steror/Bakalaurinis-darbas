...
\section{Svetainės prototipas}
\subsection{Kūrimo procesas}
...
\pagebreak
\subsection{Realizuoti reikalavimai}
Prototipo kūrimo metu buvo bandoma įgyvendinti užsibrėžtus reikalavimus svetainei ir atsižvelgti į projektavimo gaires tam, kad sukurta svetainė neturėtų pradinės sistemos trūkumų ir kūrimo metu nekiltų kitų panaudojamumo trūkumų. Gautasis prototipas įgyvendina šiuos reikalavimus ir projektavimo gaires: 
\begin{enumerate}
	\item Nefunkcinį reikalavimą 5.2.1 - paieškos laukas turi tik vieną įvedimo lauką ir mygtuką, gali būti operuojamas pele ir klaviatūra.
	\item Nefunkcinį reikalavimą 5.2.2 - į paieškos lauką galima įvesti teoriškai neribotą simbolių kiekį
	\item Nefunkcinį reikalavimą 5.2.3 - paieškos laukas yra viršuje dešinėje
	\item Projektavimo gairė 5.3.2 - galima peržiūrėti visus navigacijos elementus neatidarant kito puslapio
	\item Projektavimo gairė 5.3.3 - registraciją pas gydytoją patalpinta viršutinėje navigacijos juostoje, kad būtų pasiekiama iš visų puslapių
	\item Projektavimo gairė 5.3.5 - sukurtas paspaudžiamas D.U.K. simbolis, prie kurio galima įdėti nuorodą į D.U.K. sekciją
	\item Projektavimo gairė 5.3.6 - sukurtas paspaudžiamas matomumo simbolis, prie kurio galima prikabinti JavaScript kodą, kuris pakeistų puslapio elementų stilistiką (spalvą, šriftą, šrifto dydį), kad šie būtų geriau matomi žmonėms su regos sutrikimais
	\item Projektavimo gairė 5.3.8 - nuorodos tekste, navigacijos elementai ir navigacijos slankymo mygtukas pakeičia spalvą užvedus pelę
	\item Projektavimo gairė 5.3.9 - antraštėje sukurtas paspaudžiamas logo ir puslapio pavadinimas, prie kurio galima pridėti nuorodą į pagrindinį puslapį
	\item Projektavimo gairė 5.3.10 - nuolatiniai puslapiai sudėti į meniu, sukurta nuoroda į registraciją puslapio viršuje
	\item Projektavimo gairė 5.3.13 - navigacijos sistema yra plati ir sekli
	\item Projektavimo gairė 5.3.15 - navigacijos skirtukai reaguoja į pelės užvedimą ir turi krypties ženklą žymintį plečiamumą
	\item Projektavimo gairė 5.3.18 - navigacijos kategorijos pavadintos taip, kad tiksliai apibūdintų informaciją viduje
	\item Projektavimo gairė 5.3.21 - tekste įdėta nuoroda į susijusį skyrių
	\item Projektavimo gairė 5.3.22 - naršyklės „atgal“ mygtukas grąžina į praėjusį puslapį
\end{enumerate}
